...
void MutualInfoTripleVar_reducedBias(TString theFormula_x = "fjet1MassTrimmed",TString theFormula_y = "fjet1Tau2/fjet1Tau1",
                                     TString theFormula_z = "fjet1MassSDb2",TString histFileName = "test",
                                     int numBins_x = 210,Double_t histMin_x =  -20,Double_t histMax_x = 400,
                                     int numBins_y = 100,Double_t histMin_y =    0,Double_t histMax_y = 1.0,
                                     int numBins_z = 210,Double_t histMin_z =  -20,Double_t histMax_z = 400){
  ...
  backgdTree->Draw(theFormula_z + TString(":") + theFormula_y + TString(":") + theFormula_x + TString(">>Backgd"),"weight");
  *sumHist = *signalHist + *backgdHist;
  ...
  Double_t backgdWeights = backgdHist->IntegralAndError(1,numBins_x,1,numBins_y,1,numBins_z,backgdErr);
  Double_t sumErr = 0.;
  ...
  Double_t signalEntropy = histEntropy(signalHist,numBins_x,numBins_y,numBins_z,signalWeights,signalErr,signalEntropyErr);
  Double_t backgdEntropyErr = 0.;
  Double_t backgdEntropy = histEntropy(backgdHist,numBins_x,numBins_y,numBins_z,backgdWeights,backgdErr,backgdEntropyErr);

  TH3F *signalHist_0 = new TH3F("Signal_0",TString("Signal_0;")+theFormula_x+TString(";")+theFormula_y+TString(";")+theFormula_z,
                                numBins_x,histMin_x,histMax_x,numBins_y,histMin_y,histMax_y,numBins_z,histMin_z,histMax_z);
  TH3F *backgdHist_0 = new TH3F("Backgd_0",TString("Backgd_0;")+theFormula_x+TString(";")+theFormula_y+TString(";")+theFormula_z,
                                numBins_x,histMin_x,histMax_x,numBins_y,histMin_y,histMax_y,numBins_z,histMin_z,histMax_z);
  TH3F *sumHist_0 = new TH3F("Sum_0",TString("Sum_0;")+theFormula_x+TString(";")+theFormula_y+TString(";")+theFormula_z,
                             numBins_x,histMin_x,histMax_x,numBins_y,histMin_y,histMax_y,numBins_z,histMin_z,histMax_z);
  ...
  signalTree->Draw(theFormula_z + TString(":") + theFormula_y + TString(":") + theFormula_x +
                   TString(">>Signal_0"),"weight*(abs(fjet1PartonId)==24 && event % 2 == 0)");
  backgdTree->Draw(theFormula_z + TString(":") + theFormula_y + TString(":") + theFormula_x + TString(">>Backgd_0"),"weight*(event % 2 == 0)"); 
  *sumHist_0 = *signalHist_0 + *backgdHist_0;

  Double_t sumErr_0 = 0.;
  Double_t sumWeights_0 = sumHist_0->IntegralAndError(1,numBins_x,1,numBins_y,1,numBins_z,signalErr);

  Double_t mixedErr_0 = 0.;
  Double_t mixedEntropy_0 = histEntropy(sumHist_0,numBins_x,numBins_y,numBins_z,sumWeights_0,sumErr_0,mixedErr_0);
  ...
  TH3F *signalHist_1 = new TH3F("Signal_1",TString("Signal_1;")+theFormula_x+TString(";")+theFormula_y+TString(";")+theFormula_z,
                                numBins_x,histMin_x,histMax_x,numBins_y,histMin_y,histMax_y,numBins_z,histMin_z,histMax_z);
  TH3F *backgdHist_1 = new TH3F("Backgd_1",TString("Backgd_1;")+theFormula_x+TString(";")+theFormula_y+TString(";")+theFormula_z,
                                numBins_x,histMin_x,histMax_x,numBins_y,histMin_y,histMax_y,numBins_z,histMin_z,histMax_z);
  TH3F *sumHist_1 = new TH3F("Sum_1",TString("Sum_1;")+theFormula_x+TString(";")+theFormula_y+TString(";")+theFormula_z,
                             numBins_x,histMin_x,histMax_x,numBins_y,histMin_y,histMax_y,numBins_z,histMin_z,histMax_z);
  ...
  // This event % 2 term splits the sample in half
  signalTree->Draw(theFormula_z + TString(":") + theFormula_y + TString(":") + theFormula_x +
                   TString(">>Signal_1"),"weight*(abs(fjet1PartonId)==24 && event % 2 == 1)");
  backgdTree->Draw(theFormula_z + TString(":") + theFormula_y + TString(":") + theFormula_x + TString(">>Backgd_1"),"weight*(event % 2 == 1)"); 
  *sumHist_1 = *signalHist_1 + *backgdHist_1;

  Double_t sumErr_1 = 0.;
  Double_t sumWeights_1 = sumHist_1->IntegralAndError(1,numBins_x,1,numBins_y,1,numBins_z,signalErr);

  Double_t mixedErr_1 = 0.;
  Double_t mixedEntropy_1 = histEntropy(sumHist_1,numBins_x,numBins_y,numBins_z,sumWeights_1,sumErr_1,mixedErr_1);
